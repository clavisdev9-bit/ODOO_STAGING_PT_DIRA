...
class AirMAWBPackageDetails(models.Model):
    _name = 'freight.air.mawb.package.details'
    _description = 'Freight Air MAWB Package Details'
    _rec_name = 'mawb_id'
    ...
    # Qty & Type
    # type/container kenapa duplikat? 
